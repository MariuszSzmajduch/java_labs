...
public abstract class AbstractFit implements PackingStrategy {
     ...
     */
    public String getFittingAlgorithm() { return this.fittingAlgorithm; }
     ...
     * ArrayList
     */
    public int numContainers() { return this.containers.size(); }
    ...
    public String toString() {
        ...
        sb.append(containers.stream()
        	.map(c -> "Crate " + containers.indexOf(c) + " has load " + c.getUsedCapacity())
